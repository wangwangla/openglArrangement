...
//        GaussianBlurBean bean = (GaussianBlurBean) renderBean;
        ...
        horizontal.setScaleRatio(3);
        vertical.setScaleRatio(3);

        horizontal.setBlurRadius(54);
        vertical.setBlurRadius(54);

        horizontal.setBlurOffset(5, 0);
        vertical.setBlurOffset(0, 5);
    }
    ...
    public void onDraw(int textureId) {
        ...
        output.onDraw(horizontal.getFboTextureId());
    }
    ...
    private static class Blur extends BaseRender {
        ...
        public void onSetOtherData() {
            ...
            // 计算总权重
            calculateSumWeight();
// 39   0.016666668   0.0  0.9969465
//39   0.0   0.008830022  0.9969465
...
//            System.out.println(blurRadius+"   "+blurOffsetW/getWidth()+"   "+ blurOffsetH / getHeight() +"  "+sumWeight);
        }
