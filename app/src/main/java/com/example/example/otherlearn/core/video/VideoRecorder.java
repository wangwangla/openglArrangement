...
import com.example.example.otherlearn.core.video.params.AudioEncodeParam;
import com.example.example.otherlearn.core.video.params.CameraParam;
import com.example.example.otherlearn.core.video.params.MicParam;
import com.example.example.otherlearn.core.video.params.RecordParam;
import com.example.example.otherlearn.core.video.params.VideoEncodeParam;
import com.example.example.otherlearn.opengles.egl.EglHelper;
import com.example.example.otherlearn.opengles.view.base.EGLTextureView;
...
public class VideoRecorder {
    ...
    private class RecordThread extends Thread {
        ...
        private void initMuxer() {
            try {
                mediaMuxer =
                        new MediaMuxer(recordParam.getPath(),
