...
public class CameraManager implements ICamera {
    ...
    @Override
    public void openCamera(final Activity activity, final SurfaceTexture surfaceTexture) {
    ...
    @Override
    public void openCamera(final int facing, final Activity activity, final SurfaceTexture surfaceTexture) {
        postTask(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void setPreviewSize(final Size cameraSize) {
        postTask(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void addOnCameraListener(final OnCameraListener onCameraListener) {
        postTask(new Runnable() {
            @Override
            public void run() {
    ...
    @Override
    public void removeOnCameraListener(final OnCameraListener onCameraListener) {
        postTask(new Runnable() {
            @Override
            public void run() {
